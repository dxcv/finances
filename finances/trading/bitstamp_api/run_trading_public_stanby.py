...
def stoploss_strategy(trading_client, reinvest_gap=0.2, pct_gap=0.01, fee=0.0025, invested_value=100):
    ticker = trading_client.ticker(base='btc', quote='eur')
    stoploss_value = 8683#float(ticker['last'])
